...
## Project Structure
    ...
    ├── testappdeletion_dev_50970  # Django project configurations
...
1. Clone this repo and `cd testappdeletion_dev_50970`
...
2. Clone this repo and `cd testappdeletion_dev_50970`
